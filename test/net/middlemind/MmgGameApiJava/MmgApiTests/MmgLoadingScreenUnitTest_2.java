...
public class MmgLoadingScreenUnitTest_2 {
    ...
    public void test1() {
        ...
        /*
        MmgHelper.wr("s1 lb: " + s1.GetLoadingBar().ToString());
        MmgHelper.wr("s2 lb: " + s2.GetLoadingBar().ToString());        
        MmgHelper.wr("s1 lb pos: " + s1.GetLoadingBar().GetPosition().ToString());
        MmgHelper.wr("s2 lb pos: " + s2.GetLoadingBar().GetPosition().ToString());                
        MmgHelper.wr("++++++++++++++++++++++++++");
        */
