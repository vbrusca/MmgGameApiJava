...
public class MmgScreenData {
    ...
    /**
     * Constructor for this class that sets the screen width and height to the same given values
     * as the game width and height.
     * 
    ...
    /**
     * Calculates the scale and offset needed to adjust the game screen inside the screen dimensions.
     */
