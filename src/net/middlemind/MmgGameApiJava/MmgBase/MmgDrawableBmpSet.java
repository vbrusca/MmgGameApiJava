...
public class MmgDrawableBmpSet {
    ...
    /**
     * An MmgApi level object that wraps the lower level Java graphics API and allows for drawing
     * basic shapes and objects.
     */
    public MmgPen p;
    
    /**
     * An MmgApi level object that wraps Java graphics objects and can be used to display the drawn
     * shapes and objects.
     */
    public MmgBmp img;
}
