...
public final class PlayGround {
    ...
    public static final void main(String[] args) {
        ...
        try {
            if (PlayGround.ENGINE_CONFIG_FILE != null && PlayGround.ENGINE_CONFIG_FILE.equals("") == false) {
                GameSettingsImporter dci = new GameSettingsImporter();
                boolean r = dci.ImportGameSettings(PlayGround.ENGINE_CONFIG_FILE);
        ...
        mf = new MainFrame(PlayGround.WIN_WIDTH, PlayGround.WIN_HEIGHT, PlayGround.PANEL_WIDTH, PlayGround.PANEL_HEIGHT);
        fr = new RunFrameRate(mf, FPS);

        mf.setSize(PlayGround.WIN_WIDTH, PlayGround.WIN_HEIGHT);
